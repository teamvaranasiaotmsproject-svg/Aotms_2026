...
export const FeatureGrid = () => {
    return (
        <div className="px-4 md:px-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:flex md:flex-wrap justify-center gap-3 md:gap-6 max-w-7xl mx-auto">
                {features.map((feature, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={cn(
                                "flex items-center gap-3 md:gap-4 py-3 md:py-3 px-5 md:px-6 rounded-2xl md:rounded-full shadow-lg transition-all duration-300 cursor-default group",
                                isLast
                                    ? "bg-[#FD5A1A] text-white shadow-orange-500/20"
                                    : "bg-white text-slate-800 shadow-black/5 border border-white/20 hover:bg-[#FD5A1A] hover:text-white"
                            )}
                        >
                            <div className={cn(
