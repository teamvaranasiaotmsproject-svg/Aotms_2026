...
export const WorkshopManager = ({ events, title, subtitle }: WorkshopManagerProps) => {
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 min-h-[500px]">
                    {events.length === 0 ? (
                        <div className="w-full flex flex-col items-center justify-center p-20 bg-gray-50 rounded-[32px] border border-dashed border-gray-200">
                            ...
                            <h3 className="text-xl font-bold text-gray-900">No Workshops Found</h3>
                            <p className="text-gray-500 mt-2 font-medium">Check back later for upcoming workshops.</p>
                        </div>
                    ) : (
                        <>
                            {events.length > 0 && (
