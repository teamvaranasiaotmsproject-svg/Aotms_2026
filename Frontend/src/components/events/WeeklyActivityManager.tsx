...
export const WeeklyActivityManager = ({ events, title, subtitle }: WeeklyActivityManagerProps) => {
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 min-h-[500px]">
                    {events.length === 0 ? (
                        <div className="w-full flex flex-col items-center justify-center p-20 bg-gray-50 rounded-[32px] border border-dashed border-gray-200">
                            ...
                            <p className="text-gray-500 mt-2 font-medium">Check back later for upcoming activities.</p>
                        </div>
                    ) : (
                        <>
                            {events.length > 0 && (
