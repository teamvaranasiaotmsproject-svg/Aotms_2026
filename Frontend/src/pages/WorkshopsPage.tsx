...
const WorkshopsPage = () => {
    ...
    useEffect(() => {
        if (selectedWorkshop && window.innerWidth < 1024 && detailRef.current) {
    ...
    const handleRegister = () => {
        if (selectedWorkshop?.registrationLink) {
            window.open(selectedWorkshop.registrationLink, '_blank');
        } else {
            console.warn("No registration link found for this workshop.");
        }
    };
                ...
                <div className="mb-10 flex items-end justify-between border-b border-slate-200 pb-6">
                    <div>
                        <div className="flex items-center gap-2 text-[#FF6B35] mb-2">
                            ...
                            <span className="font-mono text-xs tracking-[0.2em] opacity-90">AOTMS.LAB_ZONE</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight uppercase glitch-text">
                            Workshops <span className="text-[#FF6B35]">.INIT</span>
                        </h1>
                    </div>
                </div>
                    ...
                    <div ref={detailRef} className="lg:col-span-9 h-full pl-0 lg:pl-4 overflow-y-auto custom-scrollbar">
                        {selectedWorkshop ? (
                            <div className="h-full flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-500">
                                ...
                                <div className="bg-white shadow-xl shadow-slate-200/50 border border-slate-100 rounded-2xl p-6 md:p-10 relative overflow-hidden group">
                                    {/* Decoration Lines */}
                                        ...
                                        <div className="flex-1 space-y-4">
                                            <div className="flex flex-wrap items-center gap-4">
                                                ...
                                                <span className="text-slate-500 font-mono text-xs">
                                                    ID: <span className="text-slate-900 font-bold">{selectedWorkshop.id}</span>
                                                </span>
                                            </div>
                                            ...
                                            <div className="pt-4">
                                                ...
                                                >
                                                    <span className="relative z-10 flex items-center justify-center gap-3">
                                                        {selectedWorkshop.buttonText || "Register For Workshop"}
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-gradient-to-br from-[#0066CC]/5 to-slate-50 border border-[#0066CC]/10 p-6 rounded-xl flex items-center justify-center text-center">
                                        <div>
                                            ...
                                            <div className="text-xs font-mono text-[#0066CC]">CERTIFICATION_READY</div>
                                            <div className="text-xl font-bold text-slate-800 mt-1">Skill Verified</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="h-full flex flex-col items-center justify-center text-slate-400 font-mono border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/50 min-h-[300px]">
                                ...
                                <span>INITIALIZING_LAB_DATA...</span>
                                <span className="text-xs mt-2 opacity-50 text-slate-500">SELECT_WORKSHOP_FROM_LIST</span>
                            </div>
                        )}
                    </div>
                </div>
